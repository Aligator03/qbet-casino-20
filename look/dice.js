...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-686e8e0c');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-686e8e0c');}
...
var brandEl=document.querySelector('.rl-brand-686e8e0c');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
